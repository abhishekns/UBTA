...
namespace _SampleLib.MySampleClass {
    ...
    public class get_MyEnum : ubta.UseCase.DefaultActivity {
        
        private System.Collections.Generic.Dictionary<string, System.Type> myTypeRefs;
        
        [NonSerialized()]
        private string _get_MyEnum_rv;
        
        public get_MyEnum() {
            _Init();
        }
        
        public get_MyEnum(System.Runtime.Serialization.SerializationInfo si, System.Runtime.Serialization.StreamingContext sc) {
            _Init();
        }
        ...
        public virtual string get_MyEnum_rv {
            get {
                return _get_MyEnum_rv;
            }
            set {
                _get_MyEnum_rv = value;
            }
        }
...
;
            Action = typeof(SampleLib.MySampleClass).GetMethod("get_MyEnum", BindingFlags.Public | BindingFlags.Instance, null, paramTypes, paramModifiers);

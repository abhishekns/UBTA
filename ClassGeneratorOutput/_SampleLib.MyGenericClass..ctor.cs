...
namespace _SampleLib.MyGenericClass {
    using System;
    ...
    public class Constructor : ubta.UseCase.DefaultActivity {
        ...
        private string _T1 = "SampleLib.MyClassA";
        
        private string _T2 = "SampleLib.MyClassB";
        ...
        [Description("Specify a generic argument of type SampleLib.MyClassA")]
        ...
        [Browsable(true)]
        [EditorBrowsable(EditorBrowsableState.Advanced)]
        [Description("Specify a generic argument of type SampleLib.MyClassB")]
        [Category("GenericParameters")]
...
;
            Action = typeof(SampleLib.MyGenericClass<SampleLib.MyClassA, SampleLib.MyClassB>).GetConstructor( BindingFlags.Public | BindingFlags.Instance, null, paramTypes, paramModifiers);
            InstanceType = typeof(SampleLib.MyGenericClass<SampleLib.MyClassA, SampleLib.MyClassB>);;
        }
    }
}

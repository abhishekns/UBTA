...
namespace _SampleLib.MyInterfaceGenerics {
    ...
    public class DoSomethingElse : ubta.UseCase.DefaultActivity {
        ...
        public DoSomethingElse(System.Runtime.Serialization.SerializationInfo si, System.Runtime.Serialization.StreamingContext sc) {
            _Init();
        }
...
;
            Action = typeof(SampleLib.MyInterfaceGenerics<SampleLib.IA, SampleLib.IB>).GetMethod("DoSomethingElse", BindingFlags.Public | BindingFlags.Instance, null, paramTypes, paramModifiers);

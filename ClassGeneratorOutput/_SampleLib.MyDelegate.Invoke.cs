...
namespace _SampleLib.MyDelegate {
    ...
    public class Invoke : ubta.UseCase.DefaultActivity {
        ...
        public Invoke(System.Runtime.Serialization.SerializationInfo si, System.Runtime.Serialization.StreamingContext sc) {
            _Init();
        }
...
;
            Action = typeof(SampleLib.MyDelegate).GetMethod("Invoke", BindingFlags.Public | BindingFlags.Instance, null, paramTypes, paramModifiers);

...
namespace _SampleLib.MySampleClass {
    ...
    public class GetSomeInt : ubta.UseCase.DefaultActivity {
        
        private System.Collections.Generic.Dictionary<string, System.Type> myTypeRefs;
        
        [NonSerialized()]
        private string _GetSomeInt_rv;
        
        public GetSomeInt() {
            _Init();
        }
        
        public GetSomeInt(System.Runtime.Serialization.SerializationInfo si, System.Runtime.Serialization.StreamingContext sc) {
            _Init();
        }
        ...
        public virtual string GetSomeInt_rv {
            get {
                return _GetSomeInt_rv;
            }
            set {
                _GetSomeInt_rv = value;
            }
        }
...
;
            Action = typeof(SampleLib.MySampleClass).GetMethod("GetSomeInt", BindingFlags.Public | BindingFlags.Instance, null, paramTypes, paramModifiers);
